...
class _SkinScanScreenState extends State<SkinScanScreen> {
  ...
  Future<void> _analyzeImage() async {
    ...
    try {
      ...
      if (_imageFile != null) {
        // Analyze with image
        scanResult = await _scanService.createSkinScan(
          userId: user.uid,
        ...
        scanResult = await _scanService.createSkinScanWithoutImage(
          userId: user.uid,
          symptoms: _symptomsController.text.trim(),
        );
      }
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    hintText: 'E.g., Itchy red rash that appeared 2 days ago...',
